    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white border-b px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex gap-6 items-center">
          ...
          <Link to="/my-applications" className="font-medium text-blue-600 px-2 py-1 rounded bg-blue-50">My Applications</Link>
          <Link to="/applicant-profile" className="font-medium text-gray-700 hover:text-blue-600">Profile</Link>
